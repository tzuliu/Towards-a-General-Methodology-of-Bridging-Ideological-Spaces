...
#ggsave("transform_illustration.png", p, width=10, height=5.5)

# Save individual figures
#ggsave("sp0.png", sp0, width=3, height=3.2)
#ggsave("sp1.png", sp1, width=3, height=3.2)
#ggsave("sp2.png", sp2, width=3, height=3.2)
#ggsave("sp3.png", sp3, width=3, height=3.2)
#ggsave("sp4.png", sp4, width=3, height=3.2)
#ggsave("sp5.png", sp5, width=3, height=3.2)
