...
save(d, file="20s_2000t_ooc.RData")
...
save(d, file="50s_2000t_ooc.RData")
...
save(d, file="100s_2000t_ooc.RData")
...
save(d, file="500s_2000t_ooc.RData")
...
save(d, file="1000s_2000t_ooc.RData")