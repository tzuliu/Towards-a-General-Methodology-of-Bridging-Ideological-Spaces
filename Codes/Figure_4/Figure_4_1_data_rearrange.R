## Validating Synthetic Anchors (UTAS 2012) Data Rearrangement
...
load(paste0(projdir, "/Outputs/simulation/utas12_sim_400_0020s_cand.rda"))
...
load(paste0(projdir, "/Outputs/simulation/utas12_sim_400_0050s_cand.rda"))
...
load(paste0(projdir, "/Outputs/simulation/utas12_sim_400_0100s_cand.rda"))
...
load(paste0(projdir, "/Outputs/simulation/utas12_sim_400_0500s_cand.rda"))

(tmp500_1h <- head(d[[1]]$coord1D))
(tmp500_1t <- tail(d[[1]]$coord1D))
(tmp500_2h <- head(d[[1]]$coord2D))
(tmp500_2t <- tail(d[[1]]$coord2D))
...
load(paste0(projdir, "/Outputs/simulation/utas12_sim_400_1000s_cand.rda"))

(tmp1000_1h <- head(d[[1]]$coord1D))
(tmp1000_1t <- tail(d[[1]]$coord1D))
(tmp1000_2h <- head(d[[1]]$coord2D))
(tmp1000_2t <- tail(d[[1]]$coord2D))
...
d <- readRDS(paste0(projdir, "/Outputs/simulation/utas12_sim_400_clean_cand.rds"))

dmean_x[[6]] <- na.omit(d[,1])
dmean_y[[6]] <- na.omit(d[,2])
...
save(dmean_var_x, file=paste0(projdir, "/Outputs/simulation/utas12_sim_400_mean_dens_x.rda"))
save(dmean_var_y, file=paste0(projdir, "/Outputs/simulation/utas12_sim_400_mean_dens_y.rda"))
