...
## Load Data
load(paste0(projdir, "/Outputs/simulation/mean_dens_group_x.rda"))
load(paste0(projdir, "/Outputs/simulation/mean_dens_group_y.rda"))
...
#+
ggsave(paste0(projdir, "/Outputs/simulation/outsample_density_new.pdf"), p, width=6, height=4)